...
def emulandice_postprocess_glaciers(
    *,
    ...
    ncvar_attributes = {
        "description": "Local SLR contributions from glaciers according to emulandice glaciers workflow",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run the post-processing stage for the emulandice glaciers SLR projection workflow",
