...
def emulandice_postprocess_AIS(locationfilename, chunksize, pipeline_id):
    ...
    ncvar_attributes = {
        "description": "Local SLR contributions from icesheet according to emulandice AIS workflow",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run the post-processing stage for the emulandice AIS SLR projection workflow",
